...
HD_PWD='C:/Users/91629/Desktop/mmu/project/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sv32_test_new.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sv32_test_new.tcl
