...
HD_PWD='C:/Users/91629/Desktop/mmu/project/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sv32_test_new.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sv32_test_new.tcl -notrace
